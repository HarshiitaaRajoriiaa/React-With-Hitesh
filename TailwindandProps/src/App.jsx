...
function App() {
  ...
  return (
    <>
      ...
      {/* card 02 - girl */}
      <div className="relative h-[400px] w-[300px] rounded-md m-12">
        <img
      ...
      <Card username={"harshita"} btn='clickme' about="about harshita"/>
      <Card username={"Himanshi Mittal" } btn="click me for to know more about me" about ="about himanshu mittal"/> 
